...
- `7.2.9-fpm-4yii2`, `fpm-4yii2` ([yii2/Dockerfile](./yii2/Dockerfile))
- `7.2.9-fpm-4yii2-xdebug`, `fpm-4yii2-xdebug` ([yii2-xdebug/Dockerfile](./yii2-xdebug/Dockerfile))
>note: based on `fpm-alpine3.7`
- `7.2.9-fpm-alpine-4yii2`, `fpm-alpine-4yii2` ([yii2-alpine/Dockerfile](./yii2-alpine/Dockerfile))
- `7.2.9-fpm-alpine-4yii2-xdebug`, `fpm-alpine-4yii2-xdebug` ([yii2-alpine-xdebug/Dockerfile](./yii2-alpine-xdebug/Dockerfile))
- `7.2.9-fpm-alpine-4yii2-supervisor`, `fpm-alpine-4yii2-supervisor` ([yii2-alpine-supervisor/Dockerfile](./yii2-alpine-supervisor/Dockerfile))
- `7.2.9-fpm-alpine-4yii2-supervisor-xdebug`, `fpm-alpine-4yii2-supervisor-xdebug` ([yii2-alpine-supervisor-xdebug/Dockerfile](./yii2-alpine-supervisor-xdebug/Dockerfile))
...
`docker pull bscheshir/php:7.2.9-fpm-4yii2-xdebug`

## for zts 

- `7.2.9-zts`, `zts` ([zts/Dockerfile](./zts/Dockerfile))
- `7.2.9-zts-xdebug`, `zts-xdebug` ([zts-xdebug/Dockerfile](./zts-xdebug/Dockerfile))
...
services:
  php:
    image: bscheshir/php:7.2.9-fpm-4yii2-xdebug
    restart: always
    volumes:
...
services:
  php-supervisor: # for workers
    image: bscheshir/php:7.2.9-fpm-alpine-4yii2-supervisor-xdebug
    restart: always
    volumes:
      - ../php-code:/var/www/html #php-code
...
```sh
docker build -t bscheshir/php:7.2.9-fpm-alpine-4yii2-xdebug -t bscheshir/php:fpm-alpine-4yii2-xdebug --pull -- ./yii2-alpine-xdebug
docker push bscheshir/php:7.2.9-fpm-alpine-4yii2-xdebug
docker push bscheshir/php:fpm-alpine-4yii2-xdebug
```
Another `alpine` images
```sh
docker build -t bscheshir/php:7.2.9-fpm-alpine-4yii2 -t bscheshir/php:fpm-alpine-4yii2 --pull -- ./yii2-alpine
docker push bscheshir/php:7.2.9-fpm-alpine-4yii2
...
docker push bscheshir/php:7.2.9-fpm-alpine-4yii2-supervisor-xdebug
...
docker push bscheshir/php:7.2.9-fpm-alpine-4yii2-supervisor
