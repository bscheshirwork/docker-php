...
- `7.1.6-fpm-4yii2`, `fpm-4yii2` ([yii2/Dockerfile](./yii2/Dockerfile))
- `7.1.6-fpm-4yii2-xdebug`, `fpm-4yii2-xdebug` ([yii2-xdebug/Dockerfile](./yii2-xdebug/Dockerfile))
- `7.1.6-fpm-alpine-4yii2`, `fpm-alpine-4yii2` ([yii2-alpine/Dockerfile](./yii2-alpine/Dockerfile))
- `7.1.6-fpm-alpine-4yii2-xdebug`, `fpm-alpine-4yii2-xdebug` ([yii2-alpine-xdebug/Dockerfile](./yii2-alpine-xdebug/Dockerfile))
...
`docker pull bscheshir/php:7.1.6-fpm-4yii2-xdebug`

## for zts 

- `7.1.6-zts`, `zts` ([zts/Dockerfile](./zts/Dockerfile))
- `7.1.6-zts-xdebug`, `zts-xdebug` ([zts-xdebug/Dockerfile](./zts-xdebug/Dockerfile))
...
services:
  php:
    image: bscheshir/php:7.1.6-fpm-4yii2-xdebug
    restart: always
    volumes:
